...
Calcium oxide is also produced in a process known as \textbf{slaking}. This is then reacted with water to form calcium hydroxide.

\begin{align}
	CaO(s) + H_{2}O(l) \rightarrow Ca(OH)_{2}
\end{align}

Calcium hydroxide is then reacted with the produced ammonium chloride \(NH_{4}Cl\) from the equilibrium reaction, to form ammonia gas, calcium chloride and water.
...
\(NaCl(aq)\), \(NH_{3}(aq)\), \(CO_{2}\) and \(H_{2}O\) are the key reactants within the equilibrium reaction. \(NaCl(aq)\) is brine, a highly concentrated and commonly-occuring salt solution which can be sourced underground. \(NH_{3}(aq)\), although expensive to produce (most commonly through the Haber Process), is usually recycled in high person in the reaction, as depicted at (7) in the flowchart. Brine and ammonia gas is reacted with water and carbon dioxide in a Solvay tower (up to 25 metres high). 
