...
\begin{center}
\includegraphics[scale=0.4]{solvay.jpeg}
\end{center}

\subsubsection{Equilibrium reaction}
...
When heated, sodium bicarbonate forms sodium carbonate, the final product.

\begin{align}
	2NaHCO_{3} + heat \rightarrow Na_{2}CO_{3} + H_{2}O(g) + CO_{2}
\end{align}

\subsubsubsection{Reactants in the equilibrium reaction}

\(NaCl(aq)\), \(NH_{3}(aq)\), \(CO_{2}\) and \(H_{2}O\) are the key reactants within the equilibrium reaction. \(NaCl(aq)\) is brine, a highly concentrated and commonly-occuring salt solution which can be sourced underground. When fed through the ammonia absorber at (1), it also adds \(NH_{3}(aq)\) to the reaction. \(NH_{3}(aq)\), although expensive to produce (most commonly through the Haber Process), is usually recycled in high proportions during the reaction, as depicted at (7) in the flowchart. 

NEED TO DO MORE

	The key equilibrium reaction involves saturating brine (sodium chloride solution) with ammonia gas and carbon dioxide to form ammonium chloride and sodium bicarbonate, which takes place in the solvay tower at (3) in the diagram. At low temperatures, the reaction shifts right towards the exothermic products side of the reaction. Sodium bicarbonate crystallises at low temperatures, hence it is solid.
	

\subsubsection{Producing carbon dioxide}

In order to faciliate the equilbrium reaction, carbon dioxide must be produced in sufficient quantities. Often, calcium carbonate is heated to produce carbon dioxide and calcium oxide, a process commonly known as \textbf{calcination}.

\begin{align}
	CaCO_{3} + heat \rightarrow CaO + CO_{2}
\end{align}

\subsubsection{Producing ammonia gas}

In the previous reaction, calcium oxide is also produced alongside carbon dioxide. This can be used to form ammonia gas. It is first reacted with water to form calcium hydroxide in a process known as \textbf{slaking}.

\begin{align}
	CaO(s) + H_{2}O(l) \rightarrow Ca(OH)_{2}
\end{align}

Calcium hydroxide is then reacted with the produced ammonium chloride \(NH_{4}Cl\) from the equilibrium reaction, to form ammonia gas, calcium chloride and water. Hence, ammonia gas is often recycled through this reaction.
